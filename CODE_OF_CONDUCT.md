...
> 本文采用 [贡献者公约（Contributor Covenant）3.0 版](https://www.contributor-covenant.org/version/3/0/) 官方简体中文译本，仅填入了星屿的举报渠道。
>
> **为什么这个项目认真对待行为准则**：星屿的 issue 区会有孤独症孩子的家长出没。一句轻慢的评论，对他们的杀伤远超一般技术社区。这里的规矩优先保护的是他们。
...
考虑到本项目的使用者是孤独症谱系儿童的家庭，以下行为同样视为违反本准则：

- 在公开讨论中泄露他人（尤其是儿童）的照片、姓名、就读机构等可识别信息——**包括当事人自己不慎发布的内容，请勿转述或扩散**；
- 以"病""缺陷""不正常"等贬损性框架谈论孤独症人士；本项目统一使用中性、尊重的表述（见 [CONTEXT.md](CONTEXT.md) 词库）；
- 借项目讨论区推销任何"包好""根治"类产品或服务。

## 通报问题

即使社区成员之间尽其所能地合作，也仍然可能发生矛盾。并不是所有冲突都涉及违反行为准则，本准则旨在强化受鼓励的行为与规范，它们有助于预防冲突并将伤害降到最低。

当事件发生时，及时报告非常重要。要报告可能的违规行为，**请发送邮件至 starry-isle@outlook.com**。邮件中请尽量说明：发生了什么、在哪里发生（issue/PR 链接或截图）、涉及哪些人、以及你希望得到怎样的处理。
...
1. 星屿目前由**一位维护者**运作，收到举报后**尽力而为，通常一周内回应**，不承诺服务等级；
2. 若举报所指向的正是维护者本人，本项目暂无内部申诉层级。此时你可以向 GitHub 官方举报（[Report abuse](https://github.com/contact/report-abuse)），这是独立于本项目的渠道。等项目出现第二位稳定维护者，会补上共同处理机制。
...
贡献者公约 由 Organization for Ethical Source 负责维护，并以 CC BY-SA 4.0 许可协议发布。查看该许可协议请访问：[https://creativecommons.org/licenses/by-sa/4.0/](https://creativecommons.org/licenses/by-sa/4.0/)。本文（含星屿的补充约定）同样以 CC BY-SA 4.0 发布。
